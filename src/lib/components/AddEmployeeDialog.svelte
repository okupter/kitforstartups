      ...
      >
        <div class="flex flex-col items-start justify-center">
          ...
          <div class="flex flex-col items-start justify-center pb-2">
            ...
            <input type="text" name="phone" id="phone" class="h-10 w-[240px] rounded-md px-3 py-2 text-neutral-700" required />
          </div>
          ...
          <div class="flex flex-col items-start justify-center pb-2">
            ...
            <input type="text" name="email" id="email" class="h-10 w-[240px] rounded-md px-3 py-2 text-neutral-700" />
          </div>
          ...
          <div class="flex flex-col items-start justify-center pb-2">
            ...
            <input type="text" name="address" id="address" required class="h-10 w-[240px] rounded-md px-3 py-2 text-neutral-700" />
          </div>
          ...
          <div class="flex flex-col items-start justify-center pb-2">
            ...
            <input type="text" name="address_2" id="address_2" class="h-10 w-[240px] rounded-md px-3 py-2 text-neutral-700" />
          </div>
          ...
          <div class="flex flex-col items-start justify-center pb-2">
            ...
            <input type="text" name="city" id="city" class="h-10 w-[240px] rounded-md px-3 py-2 text-neutral-700" required />
          </div>
          ...
          <div class="flex flex-col items-start justify-center pb-2">
            ...
            <input type="text" name="state" id="state" class="h-10 w-[240px] rounded-md px-3 py-2 text-neutral-700" required />
          </div>
