import type { campaigns, employee, employeeCodes, employeeNotes, employeeProfile, payrollCycle, paystub, user, userKey, userProfile } from '$lib/drizzle/mysql/schema';
